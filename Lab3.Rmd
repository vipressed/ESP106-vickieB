...
y_max <- max(air_us$indoor, air_us$outdoor_total, air_china$indoor, air_china$outdoor_total, na.rm = TRUE)

plot(air_us$Year, air_us$indoor, type = "l", col = "blue", lty = 1, ylim = c(0, y_max), xlab = "Year", ylab = "Deaths per 100,000 people", main = "Indoor and Outdoor Air Pollution Death Rates Over Time")
...
legend("topright", legend = c("United States - Indoor", "United States - OUtdoor", "China - Indoor", "China - Outdoor"), col = c("blue", "blue", "red", "red"), lty = c(1,2,1,2), bty = "n")
...
plot(air_gdp$log_GDP, air_gdp$indoor, ylim = y_limits, xlab = "Log per-capita GDP", ylab = "Indoor air pollution deaths", main = "Indoor deaths vs GDP", pch = 19, col = "blue")

plot(air_gdp$log_GDP, air_gdp$pm + air_gdp$ozone, ylim = y_limits, xlab = "Log per-capita GDP", ylab = "Outdoor air pollution deaths", main = "Outdoor deaths vs GDP", pch = 19, col = "red")
